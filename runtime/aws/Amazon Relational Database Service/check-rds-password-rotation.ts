        ...
        try {
          ...
          if (loginProfile.LoginProfile?.CreateDate) {
            ...
            results.checks.push({
              ...
              status: passwordAge <= MAX_PASSWORD_AGE_DAYS ? ComplianceStatus.PASS : ComplianceStatus.FAIL,
              message:
            ...
            for (const key of accessKeys.AccessKeyMetadata) {
              if (key.CreateDate) {
                ...
                results.checks.push({
                  ...
                  resourceArn: user.Arn,
                  status: keyAge <= MAX_ACCESS_KEY_AGE_DAYS ? ComplianceStatus.PASS : ComplianceStatus.FAIL,
                  message:
