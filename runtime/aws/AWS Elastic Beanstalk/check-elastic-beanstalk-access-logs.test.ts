...
describe('checkElasticBeanstalkAccessLogs', () => {
            ...
            mockElasticBeanstalkClient
                ...
                .resolves({
                    ConfigurationSettings: [{
                        OptionSettings: [
                            { Namespace: 'aws:elb:loadbalancer', OptionName: 'AccessLogsS3Enabled', Value: 'true' }
                        ]
                    }]
                });
    ...
    describe('Non-Compliant Resources', () => {
        it('should return FAIL when access logs are disabled', async () => {
            ...
            mockElasticBeanstalkClient
                ...
                .resolves({
                    ConfigurationSettings: [{
                        OptionSettings: [
                            { Namespace: 'aws:elb:loadbalancer', OptionName: 'AccessLogsS3Enabled', Value: 'false' }
                        ]
                    }]
                });
        ...
        it('should handle multiple environments with mixed compliance', async () => {
            const secondEnv = { ...mockEnvironment, EnvironmentName: 'test-env-2', EnvironmentId: 'e-987654321' };
