...
describe("checkEcrTagImmutability", () => {
    ...
    describe("Compliant Resources", () => {
        it("should return PASS when repository has immutable tags", async () => {
            ...
            const result = await checkEcrTagImmutability("us-east-1");
    ...
    describe("Non-Compliant Resources", () => {
        it("should return FAIL when repository has mutable tags", async () => {
            ...
            expect(result.checks[0].message).toBe("ECR repository does not have tag immutability enabled");
        });
    ...
    describe("Error Handling", () => {
        it("should return ERROR when API call fails", async () => {
            mockEcrClient.on(DescribeRepositoriesCommand).rejects(
                new Error("Failed to describe repositories")
            );
