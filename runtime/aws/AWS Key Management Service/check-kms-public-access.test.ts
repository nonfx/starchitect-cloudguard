...
describe("checkKmsPublicAccess", () => {
    ...
    describe("Compliant Resources", () => {
        it("should return PASS for keys with private policies", async () => {
            ...
            const result = await checkKmsPublicAccess("us-east-1");
    ...
    describe("Non-Compliant Resources", () => {
        ...
        it("should handle mixed policy configurations", async () => {
            ...
            mockKmsClient
                .on(GetKeyPolicyCommand, { KeyId: "key-1" }).resolves(mockPublicPolicy)
                .on(GetKeyPolicyCommand, { KeyId: "key-2" }).resolves(mockPrivatePolicy);
