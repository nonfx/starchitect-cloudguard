...
async function checkDocDBClusterEncryption(
...
export default {
	...
	description:
		"Amazon DocumentDB clusters must implement encryption at rest using AES-256 for enhanced data security and compliance.",
	controls: [
		{
