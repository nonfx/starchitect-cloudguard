// @ts-nocheck
import { EC2Client, DescribeVolumesCommand, GetEbsEncryptionByDefaultCommand } from "@aws-sdk/client-ec2";
...
describe("checkEbsVolumeEncryption", () => {
    ...
    describe("Compliant Resources", () => {
        it("should return PASS when default encryption is enabled and all volumes are encrypted", async () => {
            mockEC2Client
                ...
                .resolves({ EbsEncryptionByDefault: true });
    ...
    describe("Non-Compliant Resources", () => {
        it("should return FAIL when default encryption is disabled", async () => {
            ...
            expect(result.checks[0].message).toBe("EBS encryption by default is not enabled in this region");
        });
    ...
    describe("Error Handling", () => {
        ...
        it("should return ERROR when DescribeVolumes fails", async () => {
            ...
            mockEC2Client
                ...
                .rejects(new Error("Failed to describe volumes"));
