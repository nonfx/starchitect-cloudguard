...
const mockNonCompliantAccessPoint = {
    ...
    AccessPointArn: 'arn:aws:elasticfilesystem:us-east-1:123456789012:access-point/fsap-noncompliant456',
    RootDirectory: {
        Path: '/'
    }
};
        ...
        it('should handle multiple compliant access points', async () => {
            const multipleCompliant = [
                mockCompliantAccessPoint,
                {
                    ...
                    AccessPointArn: 'arn:aws:elasticfilesystem:us-east-1:123456789012:access-point/fsap-compliant789',
