...
const mockASGWithLaunchTemplate = {
  ...
  AutoScalingGroupARN:
    "arn:aws:autoscaling:us-east-1:123456789012:autoScalingGroup:test-asg-1",
  LaunchTemplate: {
...
const mockASGWithMixedInstances = {
  ...
  AutoScalingGroupARN:
    "arn:aws:autoscaling:us-east-1:123456789012:autoScalingGroup:test-asg-2",
...
const mockASGWithLaunchConfig = {
  ...
  AutoScalingGroupARN:
    "arn:aws:autoscaling:us-east-1:123456789012:autoScalingGroup:test-asg-3",
