...
describe("checkEc2MultipleEniCompliance", () => {
	...
	describe("Error Handling", () => {
		it("should return ERROR when DescribeInstances fails", async () => {
			mockEC2Client.on(DescribeInstancesCommand).rejects(new Error("Failed to describe instances"));
		...
		it("should return ERROR when DescribeNetworkInterfaces fails", async () => {
			...
			mockEC2Client
				...
				.rejects(new Error("Failed to describe network interfaces"));
	...
	describe("Multiple Instances", () => {
		it("should handle multiple instances with different ENI configurations", async () => {
			...
			mockEC2Client
				...
				.resolves({
					NetworkInterfaces: [{ NetworkInterfaceId: "eni-2" }, { NetworkInterfaceId: "eni-3" }]
				});
