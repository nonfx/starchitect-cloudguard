...
async function checkSubnetAutoAssignPublicIp(
...
export default {
	...
	description:
		"This control checks if EC2 subnets are configured to automatically assign public IP addresses. The control fails if the subnet's MapPublicIpOnLaunch attribute is set to true.",
	controls: [
		{
