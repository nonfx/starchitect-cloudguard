...
__rego__metadoc__ := {
	...
	"custom": {"controls":{"CIS-Google-Cloud-Platform-Foundation-Benchmark_v3.0.0":["CIS-Google-Cloud-Platform-Foundation-Benchmark_v3.0.0_1.14"]},"severity":"High","author":"Starchitect Agent"},
}
