...
__rego__metadoc__ := {
	...
	"custom": {"controls": {"CIS-Google-Cloud-Platform-Foundation-Benchmark_v3.0.0": ["CIS-Google-Cloud-Platform-Foundation-Benchmark_v3.0.0_2.2"]}, "severity": "Medium", "author": "Starchitect Agent"},
}
