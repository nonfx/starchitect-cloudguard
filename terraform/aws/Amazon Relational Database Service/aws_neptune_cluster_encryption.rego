...
__rego__metadoc__ := {
	...
	"custom": {"controls":{"AWS-Foundational-Security-Best-Practices_v1.0.0":["AWS-Foundational-Security-Best-Practices_v1.0.0_Neptune.1"]},"severity":"Medium","author":"Starchitect Agent"},
}
