...
__rego__metadoc__ := {
	...
	"custom": {"controls": {"CIS-AWS-Foundations-Benchmark_v3.0.0": ["CIS-AWS-Foundations-Benchmark_v3.0.0_4.3"], "AWS-Foundational-Security-Best-Practices_v1.0.0": ["AWS-Foundational-Security-Best-Practices_v1.0.0_CloudWatch.1"]}, "severity": "High", "reviewer": "ssghait.007@gmail.com"},
}
