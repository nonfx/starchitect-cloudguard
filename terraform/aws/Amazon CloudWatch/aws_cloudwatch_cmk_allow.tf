...
resource "aws_cloudwatch_metric_alarm" "cmk_changes_alarm" {
  alarm_name          = "CMKChangesAlarm"
  comparison_operator = "GreaterThanOrEqualToThreshold"
  evaluation_periods  = "1"
  metric_name         = aws_cloudwatch_log_metric_filter.cmk_changes.metric_transformation[0].name
  namespace           = aws_cloudwatch_log_metric_filter.cmk_changes.metric_transformation[0].namespace
  period              = "300"
  statistic           = "Sum"
  threshold           = "1"
