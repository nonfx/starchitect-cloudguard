...
__rego__metadoc__ := {
	...
	"custom": {"controls": {"CIS-AWS-Database-Services-Benchmark_v1.0.0": ["CIS-AWS-Database-Services-Benchmark_v1.0.0_5.6"]}, "severity": "Medium", "reviewer": "ssghait.007@gmail.com"},
}
