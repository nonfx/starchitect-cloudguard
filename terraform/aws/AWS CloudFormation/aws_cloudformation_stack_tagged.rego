...
__rego__metadoc__ := {
	...
	"custom": {"controls":{"AWS-Foundational-Security-Best-Practices_v1.0.0":["AWS-Foundational-Security-Best-Practices_v1.0.0_CloudFormation.2"]},"severity":"Low","author":"Starchitect Agent"},
}
