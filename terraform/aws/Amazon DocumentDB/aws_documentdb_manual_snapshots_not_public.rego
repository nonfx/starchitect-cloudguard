...
__rego__metadoc__ := {
	...
	"custom": {"severity": "Critical", "controls": {"AWS-Foundational-Security-Best-Practices_v1.0.0": ["AWS-Foundational-Security-Best-Practices_v1.0.0_DocumentDB.3"]}, "author": "llmagent"},
}
