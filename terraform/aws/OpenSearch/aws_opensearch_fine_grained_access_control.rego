...
__rego__metadoc__ := {
	...
	"custom": {"severity": "High", "controls": {"AWS-Foundational-Security-Best-Practices_v1.0.0": ["AWS-Foundational-Security-Best-Practices_v1.0.0_Opensearch.7"]}, "author": "llmagent", "reviewer": "ssghait.007@gmail.com"},
}
