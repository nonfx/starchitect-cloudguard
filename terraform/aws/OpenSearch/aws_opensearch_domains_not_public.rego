...
__rego__metadoc__ := {
	...
	"custom": {"controls": {"AWS-Foundational-Security-Best-Practices_v1.0.0": ["AWS-Foundational-Security-Best-Practices_v1.0.0_Opensearch.2"]}, "severity": "Critical", "reviewer": "ssghait.007@gmail.com"},
}
