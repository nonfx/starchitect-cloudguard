...
__rego__metadoc__ := {
	...
	"custom": {"controls": {"AWS-Foundational-Security-Best-Practices_v1.0.0": ["AWS-Foundational-Security-Best-Practices_v1.0.0_Inspector.1"]}, "severity": "High", "author": "llmagent", "reviewer": "ssghait.007@gmail.com"},
}
