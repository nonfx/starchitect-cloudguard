...
__rego__metadoc__ := {
    ...
    "custom": {"controls":{"CIS_Microsoft_Azure_Foundations_Benchmark_v3.0.0":["CIS_Microsoft_Azure_Foundations_Benchmark_v3.0.0_9.2.a"]},"severity":"High","author":"Starchitect Agent"},
}

resource_type := "MULTIPLE"

web_apps = fugue.resources("azurerm_windows_web_app")
